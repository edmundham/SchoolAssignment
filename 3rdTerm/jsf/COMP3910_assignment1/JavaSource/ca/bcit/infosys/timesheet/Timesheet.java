...
public class Timesheet implements java.io.Serializable {
    ...
    /** Minimum number of rows for a new timesheet. **/
    public static final int MIN_NUM_ROWS = 5;
    /** Number of days in a week. */
    public static final int DAYS_IN_WEEK = 7;
    /** Number of hours in a day. */
    public static final int TOTAL_HOURS_IN_DAY = 24;
    /** Number of seconds in a hour. */
    public static final int SECONDS_IN_HOUR = 3600;
    /** Used to convert an int to long. **/
    public static final long LONG_CONVERSION = 1000L;
    
    /** Number of days needed for correct day of month value. **/
    ...
    /** The date of Saturday for the week of the timesheet. */
    ...
    public Timesheet() {
        ...
        endWeek = c.getTime();
        c.add(Calendar.DAY_OF_MONTH, DAY_DIFFERENCE);
        startWeek = c.getTime();
        overtime = new BigDecimal(0).setScale(1, BigDecimal.ROUND_HALF_UP);
        flextime = new BigDecimal(0).setScale(1, BigDecimal.ROUND_HALF_UP);
    ...
    public Timesheet(final Employee user, final Date end,
        ...
        checkFriday(end);
        endWeek = end;
        startWeek = new Date(end.getTime() 
                - DAY_DIFFERENCE * TOTAL_HOURS_IN_DAY 
                * SECONDS_IN_HOUR * LONG_CONVERSION);
        details = charges;
    }
    ...
    public List<TimesheetRow> getDetails() {
        if (details.size() < MIN_NUM_ROWS) {
            for (int i = details.size(); i < MIN_NUM_ROWS; i++) {
    ...
    /**
     * Sets start of week.
     * @param startWeek accepts a date object
     */
