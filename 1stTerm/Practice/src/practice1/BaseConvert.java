...
public class BaseConvert {
    ...
    public static void main(String[] args) {
        ...
        System.out.print ("Please enter a base 10 number to convert (Max: " + maxNumber +
                          "): ");
        ...
        baseBNum = "" + place3 + place2 + place1 + place0; // to make it string, put ""
        // Print the result
        System.out.println("This is the number in " + base + " base: " + baseBNum);
