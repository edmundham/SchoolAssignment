...
public class World implements Serializable {
     ...
     */
    public void init() {
        doublyLinkedList = new DoubleLinkedList<Cell>();
        ...
        for (int i = 0; i < worldSizeColumn; i++) {
            for (int j = 0; j < worldSizeRow; j++) {
                ...
                cell[i][j].init();
                try {
                    doublyLinkedList.addToEnd(cell[i][j]);
    ...
    /**
     * gets doubleLinkedList that contains cells.
     * @return doublyLinkedList object
     */
    public DoubleLinkedList<Cell> getDoublyLinkedList() {
        return doublyLinkedList;
    }

    /**
     * resets world so that it contains initial cells.
     */
