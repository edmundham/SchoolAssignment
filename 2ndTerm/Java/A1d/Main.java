...
public final class Main {
    ...
    public static Shape getShape(final ShapeType type, 
        ...
        // switch :-)
        final Map<ShapeType, Shape> shapeMap;
        try {
            shapeMap = new HashMap<ShapeType, Shape>();
            shapeMap.put(ShapeType.RECTANGLE, new Rectangle(width, height));
            shapeMap.put(ShapeType.TRIANGLE, new Triangle(width, height));
            shapeMap.put(ShapeType.DIAMOND, new Diamond(width, height));
            shapeMap.put(ShapeType.RTRIANGLE, new RTriangle(width, height));
            shapeMap.put(ShapeType.SQUARE, new Square(width, height));
